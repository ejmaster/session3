package com.eccEJ.MCModding.world;
...
public class OreSpawner implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int i, int j) {
         for(int t =0; t<50; t++){
          ...
          for(int t =0; t<50; t++){
             int chuckX1 = i +random.nextInt(16);
             int chuckY1 = random.nextInt(70);
             int chuckZ1 = j + random.nextInt(16);
             (new WorldGenMinable(ModBlocks.TomatoBlock,13)).generate(world, random, chuckX1, chuckY1, chuckZ1);
         }
	}
